...
const file_user_proto_rawDesc = "" +
	...
	"\aSendSms\x12\x14.user.SendSmsRequest\x1a\x15.user.SendSmsResponseB\x06Z\x04./pbb\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*SendSmsRequest)(nil),       // 6: user.SendSmsRequest
	(*SendSmsResponse)(nil),      // 7: user.SendSmsResponse
}
var file_user_proto_depIdxs = []int32{
	...
	6, // 3: user.User.SendSms:input_type -> user.SendSmsRequest
	1, // 4: user.User.Register:output_type -> user.RegisterResponse
	3, // 5: user.User.FindById:output_type -> user.FindByIdResponse
	5, // 6: user.User.FindByMobile:output_type -> user.FindByMobileResponse
	7, // 7: user.User.SendSms:output_type -> user.SendSmsResponse
